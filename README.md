...
[![Tests](https://img.shields.io/badge/tests-540%20passing-2ea44f)](#building-from-source)
...
| `fx` | 5851 | 148 | RBJ biquads, parametric EQ, compressor, channel maximiser, and the three stretchers |
...
| `server` | 6777 | 121 | HTTP/1.1 on `std::net`, routes, JSON, persistence, sessions |
| `audiolab` | 58 | — | The binary |

### Three time stretchers

All three answer the same set of controls — density, overlap, layers, the
...
## Building from source
    ...
    cargo test  --release --manifest-path core/Cargo.toml     # 540 tests
